...
SOLVENTS = {'scf': 'scf',
            ...
            'Ammonium': '[NH4+]',
            'Benzene': 'c1ccccc1',
            'Benzoat': 'C1=CC=C(C=C1)C(=O)[O-]',
            'Benzylacetat': 'CC(=O)OCc1ccccc1',
            'Butanon': 'CCC(C)=O',
            'Chloride': '[Cl-]',
            'Chloroform': 'ClC(Cl)Cl',
            'Cyclohexan': 'C1CCCCC1',
            'Di-2-butylamin': 'CCC(C)NC(C)CC',
            'Dichlormethan': 'ClCCl',
            'Diethanolamin': 'OCCNCCO',
            'Diethylenammonium': 'OCC[NH2+]CCO',
            'Diethylether': 'CCOCC',
            'Dioctylether': 'CCCCCCCCOCCCCCCCC',
            'DMA': 'CC(=O)N(C)C',
            'DMF': 'CN(C)C=O',
            'DMSO': 'CS(C)=O',
            'EC': 'O=C1OCCO1',
            ...
            'Oleic-methyl-ester': 'CCCCCCCCC=CCCCCCCCC(=O)OC',
            'Perfluoro-hexan': 'FC(F)(F)C(F)(F)C(F)(F)C(F)(F)C(F)(F)C(F)(F)F',
            'Propylenglykol': 'CC(O)CO',
            'Tetraethylenammonium': 'CC[N+](CC)(CC)CC',
            'THF': 'C1CCOC1',
            'Toluol': 'Cc1ccccc1',
            'Tributylphosphat': 'CCCCOP(=O)(OCCCC)OCCCC',
