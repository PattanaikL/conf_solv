...
class Collater:
    ...
    def __call__(self, batch):
        ...
        if isinstance(elem, BaseData):
            ...
            # create batch data object from list
            ...
            for n_atoms in batch_data.x_solute_batch.bincount():
                for _ in range(max_confs):
                    ...
                    counter += 1
            solute_confs_batch = torch.tensor(solute_confs_batch, dtype=torch.int64)
            batch_data.solute_confs_batch = solute_confs_batch
            return batch_data
